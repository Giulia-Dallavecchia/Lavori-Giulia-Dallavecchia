...
import java.io.*;
import java.lang.*;
public class Affitto_semplice implements Serializable { //Implementazione dell'interfaccia Serializable, tramite la keyword implements, nella classe Affitto_semplice 
	...
	private static Prenotazione partecipanti = new Prenotazione(); //creazione oggetto della classe Prenotazione per la gestione dei partecipanti
	...
	ArrayList<String> Dati_prenotazione = new ArrayList<String>(); //ArrayList che gestisce l'inserimento dei dati della prenotazione
	ArrayList<String> Tutte_le_date = new ArrayList<String>(); //ArrayList che gestisce tutte le date inserite in fase di prenotazione
		...
		//Inserimento prenotazione e relativi controlli effettuati sulla data
		public String Affitto_semplice() {
					Scanner input = new Scanner(System.in);
					...
					while(!fatto) { //Condizione di controllo del ciclo while
						...
						Numero_prenotazione = contatore.Contatore() + "AS" + "" + iniziali; // numero di prenotazione che contiene il contatore più le iniziali del prenotante
						...
						//inserimento dei valori nell'ArrayList che gestisce i dati della prenotazione
						Dati_prenotazione.add(data + "\n" + nome + " " + cognome + "\n" + Numero_prenotazione);
						int dimensione = Dati_prenotazione.size(); // la dimensione del ciclo for è settata alla lunghezza dell'ArrayList
						for (int i=0; i<dimensione; i++) { // Stampa dei valori presenti nell'ArrayList
							System.out.println();
							System.out.println("Dettagli prenotazione: ");
							System.out.println();
							System.out.println(Dati_prenotazione.get(i));
							System.out.println();
						}
