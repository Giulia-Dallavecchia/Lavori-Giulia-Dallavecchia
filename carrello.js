...
function Cart(){
	...
	me.paypalCheckout = function() {
		var me = this,
			...
			strn  = "https://ecommerce.nexi.it/ecomm/ecomm/DispatcherServlet?" +
		   			"&upload=1",
			counter = 1,
			ALIAS = payment_3504791 ,
			CHIAVESEGRETA = e29PQ47533yKVh2R07sX8Y45LD863339D3SC831l,  
			itemsString = "";
		...
		strn = strn + itemsString + ALIAS + CHIAVESEGRETA;
		window.open (strn, "paypall", winpar);
	};
